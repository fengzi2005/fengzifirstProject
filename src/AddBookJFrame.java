...
public class AddBookJFrame extends JFrame implements ActionListener {
    JButton sure1JBT = new JButton("确定");
    ...
    JTextField ISBNJTF = new JTextField();
    JTextField pageNumJTF = new JTextField();
    ...
    private void initImage() {
        JLabel titleJLB = new JLabel(new ImageIcon("addBookPng/增加图书类大提示.png"));
        ...
        JLabel PHJLB = new JLabel(new ImageIcon("addBookPng/publishHouse.png"));
        PHJLB.setBounds(70,260,100,100);
        this.getContentPane().add(PHJLB);

        PHJTF.setBounds(160,295,400,25);
        this.getContentPane().add(PHJTF);

        JLabel ISBNJLB = new JLabel(new ImageIcon("addBookPng/ISBN.png"));
        ISBNJLB.setBounds(87,334,66,30);
        this.getContentPane().add(ISBNJLB);

        ISBNJTF.setBounds(160,340,400,25);
        this.getContentPane().add(ISBNJTF);

        JLabel pageNumJLB = new JLabel(new ImageIcon("addBookPng/pageNum.png"));
        pageNumJLB.setBounds(87,380,66,30);
        this.getContentPane().add(pageNumJLB);

        pageNumJTF.setBounds(160,385,400,25);
        this.getContentPane().add(pageNumJTF);

        sure1JBT.setBounds(176,450,120,60);
        this.getContentPane().add(sure1JBT);
        sure1JBT.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == sure1JBT) {
            ...
            || isEmpty(authorJTF.getText()) || isEmpty(gradeJTF.getText()) || isEmpty(ISBNJTF.getText())
            || isEmpty(pageNumJTF.getText())) {
            ...
            String publishHouse = PHJTF.getText();
            String ISBN = ISBNJTF.getText();
            String pageNum = pageNumJTF.getText();
            OperateInformation operate = new DateBase();
            Result result = operate.addInfo(id,title,author,grade,publishHouse,ISBN, pageNum,"图书");
